			...
			try {
				...
				if(userInputInt > 0 && userInputInt <= 7) {
					...
					try {
						...
						//goalSetter.replaceGoalInFile(username, category, userInputFloat); <----------- Narges please implement this
						break;
			...
			try {
				...
				if(userInputInt > 0 && userInputInt <= 7) {
					...
					try {
						...
						//dataRecorder.addNewEntry(username, category, userInputFloat); <----------- Narges please implement this
						break;
					} catch (NumberFormatException e) {
						break;
					}
